...
export function Country(){
    ...
    useEffect(() => {
        async function getBorders(){
            const dataBorders = await Promise.all(country.borders.map(border => getCountry(border)));
            ...
            <div className="country-main">
                ...
                <div className="country-info">
                    ...
                    <div className="country-info-content">
                        ...
                        .map(languages => languages.name).join(', ') }
                    </div>
                </div>
                ...
                <div className="country-info">
                    <div className="country-info-title">
                        ...
                        <div className="country-info-content">
                            {borders.map(border =>
                                <Link className="country-border" key={border.cca3} 
